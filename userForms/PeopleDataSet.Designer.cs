...
namespace userForms.PeopleDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Contacts] WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Contacts] ([ContactID], [Client], [Company], [Email], [LastCall], [Name], [Telephone]) VALUES (@ContactID, @Client, @Company, @Email, @LastCall, @Name, @Telephone);
SELECT ContactID, Client, Company, Email, LastCall, Name, Telephone FROM Contacts WHERE (ContactID = @ContactID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Contacts] SET [ContactID] = @ContactID, [Client] = @Client, [Company] = @Company, [Email] = @Email, [LastCall] = @LastCall, [Name] = @Name, [Telephone] = @Telephone WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)));
SELECT ContactID, Client, Company, Email, LastCall, Name, Telephone FROM Contacts WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::userForms.Properties.Settings.Default.PeopleConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, Client, Company, Email, LastCall, Name, Telephone FROM Contacts" +
                "";
        ...
        public virtual int Fill(PeopleDataSet.ContactsDataTable dataTable) {
        ...
        public virtual PeopleDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PeopleDataSet.ContactsDataTable dataTable = new PeopleDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PeopleDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ContactID, global::System.Nullable<bool> Original_Client, string Original_Company, string Original_Email, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, string Original_Telephone) {
        ...
        public virtual int Insert(int ContactID, global::System.Nullable<bool> Client, string Company, string Email, global::System.Nullable<global::System.DateTime> LastCall, string Name, string Telephone) {
        ...
        public virtual int Update(int ContactID, global::System.Nullable<bool> Client, string Company, string Email, global::System.Nullable<global::System.DateTime> LastCall, string Name, string Telephone, int Original_ContactID, global::System.Nullable<bool> Original_Client, string Original_Company, string Original_Email, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, string Original_Telephone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<bool> Client, string Company, string Email, global::System.Nullable<global::System.DateTime> LastCall, string Name, string Telephone, int Original_ContactID, global::System.Nullable<bool> Original_Client, string Original_Company, string Original_Email, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, string Original_Telephone) {
            return this.Update(Original_ContactID, Client, Company, Email, LastCall, Name, Telephone, Original_ContactID, Original_Client, Original_Company, Original_Email, Original_LastCall, Original_Name, Original_Telephone);
        }
    }
